...
export default function NotFound() {
  return (
    <div className="mx-auto flex max-w-xl flex-col items-center px-4 py-28 text-center sm:px-6">
      <p className="titulo-display text-6xl text-acento">404</p>
      ...
      <Link
        href="/productos"
        className="mt-8 rounded-md bg-acento px-7 py-3 text-sm font-semibold text-acento-contraste transition-opacity hover:opacity-90"
      >
